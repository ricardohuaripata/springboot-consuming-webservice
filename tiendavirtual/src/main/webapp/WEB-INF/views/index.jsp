...
<body>
	...
	<div class="container mt-2">
		<div class='row'>
			...
			<!-- JSTL PARA MOSTRAR EL LISTADO COMPLETO DE PRODUCTOS-->
				...
				<div class='col-sm-4'>
					...
					<div class='card'>
						<div class='card-header text-center'>
							<h4><c:out value="${producto.tittle}" /></h4>
						</div>
						
						<div class="card-body">
							<img src='<c:out value="${producto.imageLink}"/>' width='100%'>
						</div>
						
						<div class="card-footer text-center">
							<p><c:out value="${producto.description}" /></p>
							<h4><c:out value="${producto.price}" />€</h4>
							
							<form action="carrito">
								<input type="hidden" name="idProducto" value='<c:out value="${producto.id}"/>' > 
